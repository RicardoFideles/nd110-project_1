...
def column_to_list(data, index):
    """
    Cria uma lista baseado em outra lista com várias colunas
    Argumentos:
        param1: Lista de dados
        param2: Index da Coluna
    Retorna:
        Uma lista baseada na coluna informada
...
def count_gender(data_list):
    """
    Cria um lista com o total de genêros "Male" e "Female"
    Argumentos:
        param1: Lista de dados
    Retorna:
        Uma lista [count_male, count_female]
    """
...
def most_popular_gender(data_list):
    ...
    Argumentos:
        param1: Lista de dados
    Retorna:
        Retorna uma String com o valor "Male", "Female", ou "Equal"
    """
...
def media(lista):
    ...
    Argumentos:
        param1: Lista de dados
    Retorna:
        Um float com a media de valores encontrados na lista
    """
...
def median(lista):     
    ...
    Argumentos:
        param1: Lista de dados
    Retorna:
        Um float com a mediana de valores encontrados na lista
    """                                                                             
    if len(lista) % 2 == 0:                                                                      
        n = len(lista)                                                                           
        median = (lista[n/2-1]+ lista[n/2] )/2                                                      
    else:                                                                                    
        median = lista[int(len(lista)/2)]
    return median
...
def count_items(column_list):
    """
    Conta os tipos de uma lista de dados.
    Argumentos:
        param1: Lista de dados
    Retorna:
        Uma lista com o total das ocorrências dos tipos de dados encontrados
